...
* `Ischemic heart disease ` is the Selected cause of disease in 2013, but has a wide range of uncertainty
...
```{r, warning=FALSE, message=FALSE, fig.height=10}
knitr::kable(prevalence[prevalence$small_sample == "yes", c("cause_name", "sequlae", "sex", "age")])
```
